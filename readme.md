...
| **LOCKFILE_HIT**      | 🟠 **HIGH**     | Malicious version is locked in package-lock.json/yarn.lock/pnpm-lock.yaml/bun.lock - will auto-install on every install                                                                   | ⚠️ **CRITICAL FOR CI/CD.** Delete lockfile, remove package, regenerate.                                                  |
